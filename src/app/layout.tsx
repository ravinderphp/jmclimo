...
export const metadata: Metadata = {
  ...
  description:
    "JMC Limo — San Francisco Bay Area premier luxury black car and chauffeur service. Airport transfers from SFO & OAK, corporate travel, wedding limousine, and VIP transportation. Available 24/7. Contact us for rates.",
  keywords:
  ...
  openGraph: {
    ...
    description:
      "San Francisco Bay Area premier luxury black car and chauffeur service. Airport transfers from SFO & OAK, corporate travel, weddings, and VIP events. Available 24/7.",
    type: "website",
